...
jest.mock('../../PivotHeader/PivotHeader', () => () => (
  <thead data-testid="pivot-header">PivotHeader</thead>
));
jest.mock('../../PivotBody/PivotBody', () => () => (
  <tbody data-testid="pivot-body">PivotBody</tbody>
));
